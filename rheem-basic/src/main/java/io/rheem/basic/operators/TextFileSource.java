...
import io.rheem.core.util.LimitedInputStream;
...
public class TextFileSource extends UnarySource<String> {
    ...
    @Override
    public Optional<io.rheem.core.optimizer.cardinality.CardinalityEstimator> createCardinalityEstimator(
    ...
    /**
     * Custom {@link io.rheem.core.optimizer.cardinality.CardinalityEstimator} for {@link FlatMapOperator}s.
     */
    protected class CardinalityEstimator implements io.rheem.core.optimizer.cardinality.CardinalityEstimator {
