 ...
 * {@link io.rheem.core.plan.rheemplan.ExecutionOperator}s from the same {@link Platform} goes over another
 * {@link Platform}, then we will prune the corresponding {@link PlanImplementation}. The more complete way is to
 * look only for non-cross-platform {@link io.rheem.core.platform.Junction}s. We neglect this issue for now.</p>
 */
