package io.rheem.core.optimizer.costs;
...
import io.rheem.core.optimizer.OptimizationUtils;
import io.rheem.core.optimizer.cardinality.CardinalityEstimate;
import io.rheem.core.optimizer.costs.LoadEstimator.SinglePointEstimationFunction;
import io.rheem.core.plan.rheemplan.ExecutionOperator;
import io.rheem.core.util.JuelUtils;
import io.rheem.core.util.mathex.Context;
import io.rheem.core.util.mathex.DefaultContext;
import io.rheem.core.util.mathex.Expression;
import io.rheem.core.util.mathex.ExpressionBuilder;
import io.rheem.core.util.mathex.exceptions.EvaluationException;
...
public class LoadProfileEstimators {
     ...
     * <pre>
     *     {"type":&lt;*juel*, io.rheem.core.util.mathex.mathex&gt;,
