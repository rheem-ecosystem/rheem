...
import io.rheem.core.optimizer.costs.ConstantLoadProfileEstimator;
...
import io.rheem.core.util.JsonSerializer;
...
public class AtomicExecution {
    ...
    /**
     * This {@link JsonSerializer} stores the given instances via their {@link io.rheem.core.api.Configuration}
