...
import io.rheem.core.api.configuration.CollectionProvider;
import io.rheem.core.api.configuration.ConstantValueProvider;
import io.rheem.core.api.configuration.ExplicitCollectionProvider;
import io.rheem.core.api.configuration.FunctionalCollectionProvider;
import io.rheem.core.api.configuration.FunctionalKeyValueProvider;
import io.rheem.core.api.configuration.FunctionalValueProvider;
import io.rheem.core.api.configuration.KeyValueProvider;
import io.rheem.core.api.configuration.MapBasedKeyValueProvider;
import io.rheem.core.api.configuration.ValueProvider;
...
import io.rheem.core.optimizer.cardinality.FallbackCardinalityEstimator;
import io.rheem.core.optimizer.channels.ChannelConversion;
import io.rheem.core.optimizer.costs.IntervalLoadEstimator;
...
import io.rheem.core.optimizer.costs.NestableLoadProfileEstimator;
import io.rheem.core.optimizer.costs.TimeToCostConverter;
import io.rheem.core.optimizer.enumeration.PlanEnumerationPruningStrategy;
import io.rheem.core.plan.rheemplan.ElementaryOperator;
...
import io.rheem.core.profiling.OutboundInstrumentationStrategy;
import io.rheem.core.util.Actions;
...
import static io.rheem.core.util.ReflectionUtils.instantiateDefault;
...
public class Configuration {
    ...
    private static final String BASIC_PLUGIN = "io.rheem.basic.RheemBasics.defaultPlugin()";
