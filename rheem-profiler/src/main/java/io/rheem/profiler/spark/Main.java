...
//                results = profile(
//                        io.rheem.profiler.java.OperatorProfilers.createJavaFlatMapProfiler(
...
//                final Supplier<String> randomStringSupplier = DataGenerators.createRandomStringSupplier(2, 10, new Random(42));
//                results = profile(
//                        io.rheem.profiler.java.OperatorProfilers.createJavaMapProfiler(
...
//                results = profile(
//                        io.rheem.profiler.java.OperatorProfilers.createJavaReduceByProfiler(
