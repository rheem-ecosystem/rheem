...
import io.rheem.api.util.DataQuantaBuilderCache
import io.rheem.basic.data.Record
import io.rheem.basic.operators.{TableSource, TextFileSource}
...
class JavaPlanBuilder(rheemCtx: RheemContext, jobName: String) {
  ...
  /**
    * Feed a [[JavaCollection]] into a [[io.rheem.basic.operators.CollectionSource]].
    *
